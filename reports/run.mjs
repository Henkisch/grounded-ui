// Runs grund contracts against an outside implementation's published examples and writes a report.
...
for (const [slug, spec] of Object.entries(config.components)) {
  ...
  const md = [
    `# ${config.implementation} ${version} × grund ${slug} contract ${contract.contractVersion}`,
    '',
