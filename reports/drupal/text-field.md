# Drupal core 11.4.7 × Grounded UI text-field contract 0.3.0
...
| TF-10 If the control has aria-invalid="true", there is an error message. | normative | 1 | 1 | root matches :scope:has(:is(input.form-element, textarea.form-element)[aria-invalid="true"]):not(:has(:is(.form-item__error-message, .form-item--error-message))) |
